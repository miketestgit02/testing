...
Clone down this project ... remove the .git file and then paste it into <br>github submodulizer. https://github.com/murjax/Github-Repo-Submodulizer<br>both my_repositories and Testing
